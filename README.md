...
Ever scene I got started programming, I wanted my own language. I only made this to improve my interpreter programming skills, and this is my first interpreter I ever wrote for an actual language. If you actually care about learning about MiniScript, you can learn [how to instail and run it](https://github.com/Sombrero64/MiniScript/blob/main/guides/interpreter.md), about [every command available](https://github.com/Sombrero64/MiniScript/blob/main/guides/commands.md), or [how to edit the script to add more commands](https://github.com/Sombrero64/MiniScript/blob/main/guides/editing.md).
